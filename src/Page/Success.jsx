...
function Success(props) {
  return (
    <div className="mt-6 rounded-lg w-full mix-blend-multiply bg-blue-100 max-w-md mx-auto flex flex-col justify-center items-center p-4" >
      ...
      <Link to={'/order'} className="p-1 m-1 border-2 hover:bg-green-600 hover:text-white border-green-600 text-green-600 bg-white font-bold rounded-md">See Your Order</Link>
    </div>
  );
}
