...
function Success(props) {
  return (
    <div className="mt-6 rounded-lg w-full bg-slate-400 max-w-md mx-auto flex flex-col justify-center items-center p-4" >
      <img src={success} className="mix-blend-multiply" width={200} height={200} alt="success" />
      <p className="my-5 text-green-600 font-bold text-lg">Payment Done Successfull</p>
