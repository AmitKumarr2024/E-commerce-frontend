...
function Success(props) {
  return (
    <div className="mt-6 rounded-lg w-full mix-blend-multiply bg-green-200 max-w-md mx-auto flex flex-col justify-center items-center p-4" >
      <img src={success} className="rounded-full mix-blend-multiply" width={200} height={400} alt="success" />
