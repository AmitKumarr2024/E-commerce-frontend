...
function Success(props) {
  return (
    <div className="mt-6 rounded-lg w-full mix-blend-multiply bg-[#B8CBE1] max-w-md mx-auto flex flex-col justify-center items-center p-4" >
      <img src={success} className="object-scale-down mix-blend-multiply opacity-30" width={200} height={200} alt="success" />
